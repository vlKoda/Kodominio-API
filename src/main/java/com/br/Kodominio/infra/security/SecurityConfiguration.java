    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(HttpMethod.POST, "/usuario/cadastrar").hasAnyRole("OWNER", "ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/ocorrencia/listar/id/{id}").hasAnyRole("ADMIN", "SINDICO")
                        ...
                        .requestMatchers(HttpMethod.GET, "/usuario/listar/id/{id}").hasAnyRole("ADMIN", "SINDICO")
                        .requestMatchers(HttpMethod.POST, "/condominio/cadastrar").hasAnyRole("ADMIN", "OWNER")
                        .requestMatchers(HttpMethod.DELETE, "/condominio/deletar/{id}").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/ocorrencia/deletar/{id}").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/ocorrencia/status").hasAnyRole("ADMIN", "SINDICO")
