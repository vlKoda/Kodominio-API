    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/condominio/listar/{id}").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/usuario/listar/condominio/{idCondominio}").permitAll()
                        ...
                        .requestMatchers(HttpMethod.PUT, "/ocorrencia/editar/{id}").hasAnyRole("ADMIN", "SINDICO")
                        .requestMatchers(HttpMethod.PUT, "/ocorrencia/aprovacao/{id}").hasAnyRole("ADMIN", "SINDICO")
